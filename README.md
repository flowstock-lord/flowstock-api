...
correction. They add no tables and no stored aggregates, and quantities are only ever totalled
within one product, because a product has exactly one unit of measure.
